 ...
 */
 ...
 (function() {
   ...
   s.parentNode.insertBefore(wf, s);
      ...
      <script>
          var motto_i = 0;
          var motto_array =[" Accessibility", "Reliability", "Visibility"];
          var motto_elem;
          function mottonext()
          {
              motto_i++;
              motto_elem.style.opacity = 0;
              if(motto_i > (motto_array.length -1))
              {
                  motto_i =0;
              }
              setTimeout('mottoSlide()', 1000);
          }
            function mottoSlide()
          {
              motto_elem.innerHTML = motto_array[motto_i];
              motto_elem.style.opacity = 1;
              setTimeout('mottonext()', 2000);
           }
     </script>